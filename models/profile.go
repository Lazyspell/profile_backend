...
type Profile struct {
	...
	Social     SocialMedia    `json:"contact" bson:"contact"`
...
type SocialMedia struct {
	...
	Github        string `json:"github_link" bson:"github_link"`
	LinkedIn      string `json:"linkedin_link" bson:"linkedin_link"`
	Discord       string `json:"discord_link" bson:"discord_link"`
